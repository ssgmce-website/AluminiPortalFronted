...
### Membership › Nomination (`/membership/nomination`)
```
┌──────────────────────────────────────────────────────┐
│  Alumni Membership Nomination                       │
│  Full Name [___]   Email [___]   Phone [___]        │
│  Batch Year [___]  Branch [Dropdown ▼]              │
│  Nominated By [___]  (existing member name)         │
│  [Submit Nomination]                                │
└──────────────────────────────────────────────────────┘
```
